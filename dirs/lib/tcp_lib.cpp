...
//        char             sin_zero[8];
    ...
    struct sockaddr_in server_address_info = { AF_INET, 0, htons(m_port_no),0 };//, sockaddr_in::sin_zero={0} , in_addr{0}};
...
int tcp_class::accept_client_connection(){
    ...
    struct sockaddr_in serv_addr = {AF_INET,htons(m_port_no),INADDR_ANY,0};
